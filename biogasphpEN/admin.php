...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Charts -->
      <li class="nav-item">
        <a class="nav-link" href="chartView.html">
          <i class="fas fa-fw fa-chart-area"></i>
          <span>chart view</span></a>
      </li>
        ...
        <!-- Content Row -->
            ...
            <div class="row">
              ...
              <div class="col-xl-3 col-md-4 mb-4">
                <div class="card border-left-primary shadow h-100 py-2">
                  <div class="card-body">
                    <h1 class="h5 mb-0 text-gray-900 align-center">Machine 1
                    </h1>
              ...
              <div class="col-xl-3 col-md-4 mb-4">
                <div class="card border-left-primary shadow h-100 py-2">
                  <div class="card-body">
                    <h1 class="h5 mb-0 text-gray-900 align-center">Machine 2
                    </h1>
                        <div class="row no-gutters align-items-center">
                          <div class="col mr-2">
                            <table class="table">
              ...
              <div class="col-xl-3 col-md-4 mb-4">
                <div class="card border-left-primary shadow h-100 py-2">
                  <div class="card-body">
                    <h1 class="h5 mb-0 text-gray-900 align-center">Machine 3
                    </h1>
                        <div class="row no-gutters align-items-center">
                          <div class="col mr-2">
                            <table class="table">
              ...
              <div class="col-xl-3 col-md-4 mb-4">
                <div class="card border-left-primary shadow h-100 py-2">
                  <div class="card-body">
                    <h1 class="h5 mb-0 text-gray-900 align-center">Machine 4
                    </h1>
                        <div class="row no-gutters align-items-center">
                          <div class="col mr-2">
                            <table class="table">
            ...
            <div class="row">
              ...
              <div class="col-xl-3 col-md-4 mb-4">
                <div class="card border-left-primary shadow h-100 py-2">
                  <div class="card-body">
                    <h1 class="h5 mb-0 text-gray-900 align-center">Machine 5
                    </h1>
                        <div class="row no-gutters align-items-center">
                          <div class="col mr-2">
                            <table class="table">
              ...
              <div class="col-xl-3 col-md-4 mb-4">
                <div class="card border-left-primary shadow h-100 py-2">
                  <div class="card-body">
                    <h1 class="h5 mb-0 text-gray-900 align-center">Machine 6
                    </h1>
                        <div class="row no-gutters align-items-center">
                          <div class="col mr-2">
                            <table class="table">
              ...
              <div class="col-xl-3 col-md-4 mb-4">
                <div class="card border-left-primary shadow h-100 py-2">
                  <div class="card-body">
                    <h1 class="h5 mb-0 text-gray-900 align-center">Machine 7
                    </h1>
                        <div class="row no-gutters align-items-center">
                          <div class="col mr-2">
                            <table class="table">
              ...
              <div class="col-xl-3 col-md-4 mb-4">
                <div class="card border-left-primary shadow h-100 py-2">
                  <div class="card-body">
                    <h1 class="h5 mb-0 text-gray-900 align-center">Machine 8
                    </h1>
                        <div class="row no-gutters align-items-center">
                          <div class="col mr-2">
                            <table class="table">
            ...
            <div class="row">
              ...
              <div class="col-xl-3 col-md-4 mb-4">
                <div class="card border-left-primary shadow h-100 py-2">
                  <div class="card-body">
                    <h1 class="h5 mb-0 text-gray-900 align-center">Machine 9
                    </h1>
                        <div class="row no-gutters align-items-center">
                          <div class="col mr-2">
                            <table class="table">
              ...
              <div class="col-xl-3 col-md-4 mb-4">
                <div class="card border-left-primary shadow h-100 py-2">
                  <div class="card-body">
                    <h1 class="h5 mb-0 text-gray-900 align-center">Machine 10
                    </h1>
                        <div class="row no-gutters align-items-center">
                          <div class="col mr-2">
                            <table class="table">
              ...
              <div class="col-xl-3 col-md-4 mb-4">
                <div class="card border-left-primary shadow h-100 py-2">
                  <div class="card-body">
                    <h1 class="h5 mb-0 text-gray-900 align-center">Machine 11
                    </h1>
                        <div class="row no-gutters align-items-center">
                          <div class="col mr-2">
                            <table class="table">
              ...
              <div class="col-xl-3 col-md-4 mb-4">
                <div class="card border-left-primary shadow h-100 py-2">
                  <div class="card-body">
                    <h1 class="h5 mb-0 text-gray-900 align-center">Machine 12
                    </h1>
                        <div class="row no-gutters align-items-center">
                          <div class="col mr-2">
                            <table class="table">
            ...
            <div class="row">
              ...
              <div class="col-xl-3 col-md-4 mb-4">
                <div class="card border-left-primary shadow h-100 py-2">
                  <div class="card-body">
                    <h1 class="h5 mb-0 text-gray-900 align-center">Machine 13
                    </h1>
                        <div class="row no-gutters align-items-center">
                          <div class="col mr-2">
                            <table class="table">
              ...
              <div class="col-xl-3 col-md-4 mb-4">
                <div class="card border-left-primary shadow h-100 py-2">
                  <div class="card-body">
                    <h1 class="h5 mb-0 text-gray-900 align-center">Machine 14
                    </h1>
                        <div class="row no-gutters align-items-center">
                          <div class="col mr-2">
                            <table class="table">
              ...
              <div class="col-xl-3 col-md-4 mb-4">
                <div class="card border-left-primary shadow h-100 py-2">
                  <div class="card-body">
                    <h1 class="h5 mb-0 text-gray-900 align-center">Machine 15
                    </h1>
                        <div class="row no-gutters align-items-center">
                          <div class="col mr-2">
                            <table class="table">
              ...
              <div class="col-xl-3 col-md-4 mb-4">
                <div class="card border-left-primary shadow h-100 py-2">
                  <div class="card-body">
                    <h1 class="h5 mb-0 text-gray-900 align-center">Machine 16
                    </h1>
                        <div class="row no-gutters align-items-center">
                          <div class="col mr-2">
                            <table class="table">
